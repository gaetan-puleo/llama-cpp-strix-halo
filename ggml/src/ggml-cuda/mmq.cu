...
static bool use_rdna3_5_q45_id_narrow(const mmq_args & args) {
    ...
    return (args.type_x == GGML_TYPE_Q4_K || args.type_x == GGML_TYPE_Q5_K) && GGML_CUDA_CC_IS_RDNA3_5(cc) &&
        args.ids_dst != nullptr && ((args.ncols_x == 2048 && args.nrows_x == 512) ||
        (args.ncols_x == 512 && args.nrows_x == 2048)) && args.nchannels_x == 256 && args.nchannels_y > 0 &&
